...
public class HistoryAlarmController extends BaseController {
	...
	@ResponseBody
	public Map<String,Object> getOptionQueryAlarm(String chineseOrEnglishFlag,Integer pageNumber,Integer pageSize,
			String startDatetime,String endDatetime,String alarmLevel,
			String isConfirm,String isClear,Page pageObject) throws Exception{
		...
		pageObject.setCurrentEndIndex(Math.min(pageNumber * pageSize, (int)alarmLogCount));
		//条件查询告警日志
	...
	public String deleteAlarm(String deleteTime) throws Exception{
		...
		//查询出最大的日志告警序列号
		PageData selectMaxSerialNumber = historyAlarmService.selectMaxNoByRaiseTime(pd);
		Long maxNoInt = ((Long)selectMaxSerialNumber.get("maxSerialNumber")).longValue();
		pd.put("maxSerialNumber", maxNoInt);
