			...
			<div class="page-content">
				<div class="row">
					...
					<form action="datajur/${msg }.do" name="Form" id="Form" method="post">
						...
						<div id="editDialog" style="padding-top: 13px;">
						...
						<div id="loadDialog" class="center" style="display:none"><br/><br/><br/><br/><br/><img src="static/images/jiazai.gif" /><br/><h4 class="lighter block green">提交中...</h4></div>
					</form>
					</div>
				</div>
			</div>
